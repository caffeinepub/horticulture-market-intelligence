...
export class Backend implements backendInterface {
    ...
    async addAlert(arg0: bigint, arg1: string, arg2: string, arg3: string, arg4: string, arg5: Array<string>): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addAlert(arg0, arg1, arg2, arg3, arg4, arg5);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async addMandi(arg0: string, arg1: string, arg2: number, arg3: bigint, arg4: Array<string>, arg5: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addMandi(arg0, arg1, arg2, arg3, arg4, arg5);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAlertsForFarmer(arg0: bigint): Promise<Array<Alert>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAlertsForFarmer(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getMandisByCrop(arg0: string): Promise<Array<Mandi>> {
        if (this.processError) {
            try {
                const result = await this.actor.getMandisByCrop(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
